...
`ItemDefs` из `DSNAtlantis-src/standard/rules.cpp`; порядок enum из `DSNAtlantis-src/standard/rules.h`.

Всего предметов: `131`.

Поля `walk`, `ride`, `fly`, `swim` показывают транспортную ёмкость или вклад предмета в соответствующий канал движения.

| # | Enum | Название | Множ. | Код | Флаги | Типы | Производство | Вес | Цена | Combat | Index | Walk | Ride | Fly | Swim |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

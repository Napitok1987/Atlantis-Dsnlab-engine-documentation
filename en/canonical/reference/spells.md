...
Magic `SkillDefs` entries from `DSNAtlantis-src/standard/rules.cpp`; active spell handling cross-checked against `DSNAtlantis-src/standard/spells.cpp`.

Total magic skills and spell-like entries: `59`.

Not every entry is an active `CAST`: foundation and passive skills are also part of the magic tree.

| # | Enum | Name | Code | Class | Special | Dependencies |
| --- | --- | --- | --- | --- | --- | --- |
